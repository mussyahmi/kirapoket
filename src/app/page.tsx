...
function MockCard({
  ...
  return (
    <div className="rounded-xl border border-border bg-card overflow-hidden">
      {title && (
        <p className="px-4 pt-3 pb-1.5 text-[11px] font-semibold text-foreground">
          {title}
        </p>
      )}
  ...
  return (
    <div className="w-full rounded-2xl bg-muted/30 border border-border shadow-2xl overflow-hidden text-xs select-none p-3 space-y-2">
        ...
        <div className="grid grid-cols-3">
          {[
            ...
            return (
              <div
                key={label}
                className="flex flex-col items-center px-3 pt-5 pb-4 gap-0.5"
              >
      ...
      <MockCard title="Spending by Category">
        <p className="-mt-1 mb-2.5 text-[9px] text-muted-foreground">
            ...
            <div key={label}>
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`inline-flex items-center justify-end gap-0.5 text-[9px] w-12 ${delta?.color ?? ""}`}
                  >
                    {delta &&
                      (delta.direction === "up" ? (
                  ...
                  <div key={name} className="space-y-1">
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <span
                          className={`inline-flex items-center justify-end gap-0.5 text-[9px] w-12 ${l2delta?.color ?? ""}`}
                        >
                          {l2delta &&
                          ...
                          ({
                            ...
                            >
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span
                                  className={`inline-flex items-center justify-end gap-0.5 text-[9px] w-12 ${l3delta?.color ?? ""}`}
                                >
                                  {l3delta &&
              ...
              <div className="space-y-1.5">
                {txs.map(({ name, sub, amount, income }) => (
                  <div key={name + sub} className="flex items-center gap-2.5">
                    <div
                      className={`size-7 rounded-full shrink-0 flex items-center justify-center ${income ? "bg-green-100 text-green-600" : "bg-red-100 text-red-500"}`}
                    >
                      {income ? (
                    ...
                    <span
                      className={`text-[10px] font-semibold shrink-0 ${income ? "text-green-600" : "text-red-500"}`}
                    >
                      {amount}
                    </span>
                  </div>
          ...
          <div className="w-full max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-16 items-center">
            ...
            <div className="flex flex-col gap-8">
              <div className="flex flex-col gap-4">
                <div
                  className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-border bg-card w-fit text-xs text-muted-foreground anim-fade-up"
                ...
                <h1
                  className="text-4xl md:text-5xl font-black tracking-tight text-foreground leading-tight anim-fade-up"
            ...
            <div
              className="w-full md:max-w-sm md:ml-auto anim-slide-right"
              style={{ animationDelay: "200ms" }}
            >
              <MockDashboard />
            </div>
