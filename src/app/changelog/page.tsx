...
const releases: Release[] = [
  {
    ...
    changes: [
      ...
      { type: "fix", text: "AI insights refresh button is disabled during cooldown with an 'Unlock tomorrow at HH:MM' label — prevents spam and makes availability clear" },
    ],
  },
  {
    version: "0.6.x",
